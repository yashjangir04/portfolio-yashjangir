...
const Home = () => {
  return (
    <div id='home'>
        ...
        <div className="w-full gap-20 md:h-screen flex flex-col md:py-0 py-25 md:flex-row px-8 md:px-24 justify-between items-center md:gap-4 mt-10 bg-[#00000089] backdrop-blur-3xl">
